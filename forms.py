...
class Customer1(FlaskForm):
    ...
    staff1_personal_notes = TextAreaField("Personal notes about staff")
    ...
    staff2_personal_notes = TextAreaField("Personal notes about staff")
    ...
    staff3_personal_notes = TextAreaField("Personal notes about staff")
